      ...
      try {
        const response = await fetch(
          "https://api.ekalakaar.com/api/v1/admin/user?role=Artist",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTQwODJjYzU1NzBkODY1NjA2NGVmNjciLCJpYXQiOjE3MDQ0NjAyNTQsImV4cCI6MTcwNDU0NjY1NH0.3bC-O4JIaVqgKmsQzpZadK0I5qBpSFSlW1vmNxb5wnM`, // replace with your access token
    ...
    <div className="container">
      <div className="row-container">
        <div className="left-heading">
          <h2>
            Manage Users -<span style={{ color: "#AD2F3B" }}>Artists</span>
          </h2>
